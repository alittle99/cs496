angular.module('calendarController', ['ui.calendar', 'ui.bootstrap', 'modalController', 'dropDownController', 'apiService'])
        .controller('CalendarCtrl', CalendarCtrl);

function CalendarCtrl($scope, $http, $compile, $timeout, uiCalendarConfig, $uibModal, $document, api) {
    var date = new Date();
    var d = date.getDate();
    var m = date.getMonth();
...
var modalController = angular.module('modalController', ['ui.bootstrap', 'apiService'])
  .controller('ModalCtrl', function ($scope, $http, $uibModal, $log, $document, api) {
    var $ctrl = this;
    $scope.tutorOptions = api.getAllTutors($http)
    $scope.studentOptions = api.getAllStudents($http)
    $ctrl.items

    function init(){
        $ctrl.items = api.getAllUsers($http)
    }
    init()
